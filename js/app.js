...
function mostrarProductos(array){   
    array.forEach(producto => {
        ...
        div.innerHTML += `<div class="cont__cajita">
        <div class="cajita">
            <div class="cajita__img"><img src=${producto.img} alt="verduras"></div>
            <p class="ventas__titulos">${producto.nombre}</p> 
            ...
            <p class="ventas__titulos">${producto.desc}</p>
            <p class="ventas__titulos">${producto.precio}</p>
            <p class="ventas__titulos">Talle: ${producto.talle}</p>
